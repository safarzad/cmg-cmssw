...
if __name__ == "__main__":
    ...
    ydAnti = ydsAnti.getSampDict("QCD",cat)
    hAnti = makeSampHisto(ydAnti,"QCD",cat,"QCD_Anti_"+cat)
    hAnti.SetTitle("Anti-selected")

    ydSele = ydsSele.getSampDict("QCD",cat)
    hSele = makeSampHisto(ydSele,"QCD",cat,"QCD_Sele_"+cat)
